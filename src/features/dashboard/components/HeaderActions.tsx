...
export const HeaderActions = () => {
  ...
  return (
    <header className="w-full bg-background-light shrink-0 z-10">
      <div className="max-w-[1920px] mx-auto px-6 md:px-10 pt-8 pb-6">
          ...
          <div className="flex flex-row gap-2 sm:gap-4 relative">
            ...
            <div className="relative" ref={filterRef}>
              <Button 
                ...
                className={cn("h-10 px-3 sm:px-4 bg-white text-slate-900 border-slate-200 hover:bg-slate-50 shadow-sm", isFilterOpen ? 'bg-slate-50 ring-2 ring-slate-100' : '')}
                aria-label="Filtros"
              >
            ...
            <div className="relative" ref={periodRef}>
              <Button 
                ...
                className={cn("h-10 px-3 sm:px-4 bg-white text-slate-900 border-slate-200 hover:bg-slate-50 shadow-sm", isPeriodOpen ? 'bg-slate-50 ring-2 ring-slate-100' : '')}
