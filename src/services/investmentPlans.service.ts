...
const mockInvestments: InvestmentPlan[] = [
  { id: '1', nome: 'ETF Global (IVVB11)', valorAtual: 15420.00, icone: 'Globe', cor: 'bg-blue-100 text-blue-600', tipo: 'ETF', dataInicio: '2023-01-10', status: 'Ativo' },
  { id: '2', nome: 'Reserva de Emergência', valorAtual: 8000.00, icone: 'Landmark', cor: 'bg-orange-100 text-orange-600', tipo: 'Poupança', dataInicio: '2022-05-15', status: 'Ativo' },
  { id: '3', nome: 'Fundos Imobiliários', valorAtual: 5120.50, icone: 'Building2', cor: 'bg-purple-100 text-purple-600', tipo: 'FII', dataInicio: '2023-03-20', status: 'Ativo' },
];
...
export const updateInvestmentPlan = async (id: string, payload: UpdateInvestmentPlanRequest): Promise<InvestmentPlan> => {
  const index = mockInvestments.findIndex(inv => inv.id === id);
